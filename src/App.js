...
const App = () => {
  ...
  //funzione che setta il click review this book e che mostra commentArea
  ...
  return (
    <>
      ...
      <TwoColumnLayout books={filteredBooks} handleReviewClick={handleReviewClick} selectedCardIndex={selectedCardIndex} showCommentArea={showCommentArea}/>
      <Footer />
    </>
  );
}
